...
if __name__ == "__main__":
    bnnRoot = "."
    npzFile = bnnRoot + "/cifar10-4w-1a.npz"
    targetDirBin = bnnRoot + "/binparam-cnvW4A1-pynq"
    targetDirHLS = bnnRoot + "/binparam-cnvW4A1-pynq/hw"
    ...
    WeightsPrecisions_integer =       [4 , 4 , 4 , 4 , 4 , 4 , 4, 4, 4]
    ...
    peCounts =   [1, 1, 1,  1, 1, 1, 1, 1, 1]
    simdCounts = [3, 2, 2, 2, 2, 2, 2, 2, 1]
